...
import com.innovarhealthcare.channelHistory.client.diff.ChannelDiffPanel;
...
public class ChannelDiffDialog extends JDialog {
    ...
    private void setupLayout(DiffPair sorted) {
        ...
        ChannelDiffPanel channelPanel = new ChannelDiffPanel(
                sorted.leftXml, sorted.rightXml, sorted.leftVersion, sorted.rightVersion);
        tabbedPane.addTab("Channel", channelPanel);
