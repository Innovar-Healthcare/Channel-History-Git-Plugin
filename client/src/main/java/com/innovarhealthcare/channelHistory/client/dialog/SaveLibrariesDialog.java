...
/**
 * Dialog for saving code template libraries to remote repository.
 ...
 */
public class SaveLibrariesDialog extends JDialog {

    private static final Logger logger = LogManager.getLogger(SaveLibrariesDialog.class);
    ...
    /**
     * Creates and shows the Save Libraries dialog
     *
     * @param parent Parent frame
     */
    public SaveLibrariesDialog(Frame parent) {
        super(parent, true);
    ...
    private void initComponents() {
        ...
        commentField.setToolTipText("Enter a commit message describing the changes to the libraries.");
        ...
        saveButton = new JButton("Save & Push");
        saveButton.addActionListener(evt -> onSaveClicked());
        ...
        processingMessageLabel = new JLabel("<html>Saving libraries to repository...<br>Please wait...</html>");
    ...
    private SaveResult performSave() {
        try {
            ...
            String operationDetails = VersionHistoryServiceClient.getInstance().saveLibraries(libraries, commitMessage, userId);

            logger.info("Libraries saved successfully: " + operationDetails);
    ...
    private void showSuccessResult(String details) {
        ...
        resultMessageLabel.setText("Libraries saved and pushed successfully!");
    ...
    private void showErrorResult(Exception error) {
        ...
        resultMessageLabel.setText("<html>Failed to save libraries:<br>" + errorMsg + "</html>");
